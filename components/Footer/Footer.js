    ...
    this.shadowRoot.innerHTML = `
      ...
      <footer class="footer glass-panel">
        <div class="footer-container">
          ...
          <div class="footer-brand">
            <a href="#" class="logo">
              ...
              <span class="logo-text">SWEETOS</span>
            </a>
            <p class="brand-desc">High-precision minimalist desk accessories curated for developers, designers, and creators.</p>
          </div>
        ...
        <div class="footer-bottom">
          <p class="copyright">&copy; ${new Date().getFullYear()} SWEETOS. All rights reserved.</p>
          <div class="socials">
