    ...
    this.shadowRoot.innerHTML = `
      ...
      <footer class="footer glass-panel">
        <div class="footer-container">
          ...
          <div class="footer-brand">
            <a href="#" class="logo">
              ...
              <span class="logo-text">${localStorage.getItem('SWEETOS_store_name') || 'SWEETOS'}</span>
            </a>
            <p class="brand-desc">${localStorage.getItem('SWEETOS_store_desc') || 'High-precision minimalist desk accessories curated for developers, designers, and creators.'}</p>
          </div>
        ...
        <div class="footer-bottom">
          <p class="copyright">&copy; ${new Date().getFullYear()} ${localStorage.getItem('SWEETOS_store_name') || 'SWEETOS'}. All rights reserved.</p>
          <div class="socials">
